...
CREATE unique nonclustered index ticket__idxv4 ON ticket(seat_id, coach_id) go
...
CREATE TABLE track
    ( id nvarchar (256) NOT NULL ,
     ...
     platform_station_id INTEGER NOT NULL ) go
